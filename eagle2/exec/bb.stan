  ...
  for (n in 1:N) {
    for (k in 1:K) {
      ...
      for (t in 1:T) {
        ...
        for (r in 1:R) {
          log_prob_unflipped_temp[t] = beta_binomial_reparam_lpmf(ys[n,t,k,r] | ns[n,t,k,r], xb[t][n], conc[k]); 
          log_prob_flipped_temp[t] = beta_binomial_reparam_lpmf(ys[n,t,k,r] | ns[n,t,k,r], -xb[t][n], conc[k]);
        }
