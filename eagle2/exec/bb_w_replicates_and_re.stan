  ...
  for (n in 1:N) {
    for (k in 1:K) {
      ...
      for (t in 1:T) {
        ...
        g = xb[t][n] + re[n,k];
        for (r in 1:R) {
          log_prob_unflipped_temp[r] = beta_binomial_reparam_lpmf(ys[n,t,k,r] | ns[n,t,k,r], g, conc[k]); 
          log_prob_flipped_temp[r] = beta_binomial_reparam_lpmf(ys[n,t,k,r] | ns[n,t,k,r], -g, conc[k]);
        }
